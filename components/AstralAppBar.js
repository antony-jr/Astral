...
export default function AstralAppBar(props) {
  ...
  return (
   ...
   <Grid container direction="row" justify="center" className={classes.searchGrid}>
        ...
        <Button  color="default" variant="outlined" className={classes.loginButton}>Login</Button>
        </Toolbar>
      </AppBar>
     </HideOnScroll>
    </div>
